...
void CMainFrame::OnSize(UINT nType, int cx, int cy)
{
	...
	CRect rectStatus = m_wndStatusBar.GetBorders();
	//m_wndStatusBar.GetItemRect(1,);
	int width = 205;
	...
	pOptionFrame->MoveWindow(m_rect.right - width, 0, width, (m_rect.bottom-47) / 2, 1);
	pImgViewerFrame->MoveWindow(0, 0, m_rect.right - width, m_rect.bottom - 47, 1);
	pNavigatorFrame->MoveWindow(m_rect.right - width, (m_rect.bottom - 47) / 2, width, (m_rect.bottom - 47) / 2, 1);
