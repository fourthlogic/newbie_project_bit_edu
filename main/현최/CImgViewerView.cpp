	...
	else if (MK_LBUTTON == nFlags && (EdgeSelect == TRUE))
	{
		...
		if (IsContainVector(SelectIndex, GroupList)) {
			for (int j = 0; j < GroupList.size(); j++) {
				...
				{
					if (true/*data[GroupList[j]].theta == 0*/) {

						if (EdgeIndex == 0)
						{
							double dX, dY;
							double a, b, c = 1;
							dX = data[GroupList[j]].RotatePts[0].x - data[GroupList[j]].RotatePts[2].x;
							dY = data[GroupList[j]].RotatePts[0].y - data[GroupList[j]].RotatePts[2].y;
							/*if ((data[GroupList[j]].RotatePts[0].x == data[GroupList[j]].RotatePts[2].x || data[GroupList[j]].RotatePts[0].y == data[GroupList[j]].RotatePts[2].y)  &&
							   (data[GroupList[j]].RotatePts[0].x == data[GroupList[j]].RotatePts[1].x || data[GroupList[j]].RotatePts[0].y == data[GroupList[j]].RotatePts[1].y)  &&
							   (data[GroupList[j]].RotatePts[2].x == data[GroupList[j]].RotatePts[1].x || data[GroupList[j]].RotatePts[2].y == data[GroupList[j]].RotatePts[1].y)
							   )
							   return;*/
							if (dX == 0)
							{
							...
							double dX2, dY2;
							double a2, b2, c2 = 1;
							dX2 = data[GroupList[j]].RotatePts[0].x - data[GroupList[j]].RotatePts[1].x;
							dY2 = data[GroupList[j]].RotatePts[0].y - data[GroupList[j]].RotatePts[1].y;
							...
							b = -a * data[GroupList[j]].RotatePts[0].x + c * data[GroupList[j]].RotatePts[0].y;
							b2 = -a2 * data[GroupList[j]].RotatePts[0].x + c2 * data[GroupList[j]].RotatePts[0].y;


							if (a == 0)
								data[GroupList[j]].RotatePts[2] = intersection(data[GroupList[j]].RotatePts[0], Point2d((c - b) / a, 1), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							else
								data[GroupList[j]].RotatePts[2] = intersection(data[GroupList[j]].RotatePts[0], Point2d(1, (a + b) / c), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							if (a2 == 0)
								data[GroupList[j]].RotatePts[1] = intersection(data[GroupList[j]].RotatePts[0], Point2d((c2 - b2) / a2, 1), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							else
								data[GroupList[j]].RotatePts[1] = intersection(data[GroupList[j]].RotatePts[0], Point2d(1, (a2 + b2) / c2), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							double ddx = data[GroupList[j]].pts[1].x - data[GroupList[j]].RotatePts[1].x;
							double ddy = data[GroupList[j]].pts[1].y - data[GroupList[j]].RotatePts[1].y;
							for (int i = 0; i < 3; i++) {
								data[GroupList[j]].RotatePts[i].x += ddx;
								data[GroupList[j]].RotatePts[i].y += ddy;
							}
						}
						else if (EdgeIndex == 1)
						{
							...
							double dX, dY;
							double a, b, c = 1;
							dX = data[GroupList[j]].RotatePts[0].x - data[GroupList[j]].RotatePts[1].x;
							dY = data[GroupList[j]].RotatePts[0].y - data[GroupList[j]].RotatePts[1].y;
							/*if (data[GroupList[j]].RotatePts[0] == data[GroupList[j]].RotatePts[2] ||
							   data[GroupList[j]].RotatePts[0] == data[GroupList[j]].RotatePts[1]||
							   data[GroupList[j]].RotatePts[2] == data[GroupList[j]].RotatePts[1])
							   return;*/
							if (dX == 0)
							{
								a = 0;
							...
							double dX2, dY2;
							double a2, b2, c2 = 1;
							dX2 = data[GroupList[j]].RotatePts[0].x - data[GroupList[j]].RotatePts[2].x;
							dY2 = data[GroupList[j]].RotatePts[0].y - data[GroupList[j]].RotatePts[2].y;
							...
							b2 = -a2 * data[GroupList[j]].RotatePts[0].x + c2 * data[GroupList[j]].RotatePts[0].y;
							if (a == 0)
								data[GroupList[j]].RotatePts[1] = intersection(data[GroupList[j]].RotatePts[0], Point2d((c - b) / a, 1), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							else
								data[GroupList[j]].RotatePts[1] = intersection(data[GroupList[j]].RotatePts[0], Point2d(1, (a + b) / c), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							if (a2 == 0)
								data[GroupList[j]].RotatePts[2] = intersection(data[GroupList[j]].RotatePts[0], Point2d((c2 - b2) / a2, 1), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							else
								data[GroupList[j]].RotatePts[2] = intersection(data[GroupList[j]].RotatePts[0], Point2d(1, (a2 + b2) / c2), data[GroupList[j]].RotatePts[1], data[GroupList[j]].RotatePts[2]);
							double ddx = data[GroupList[j]].pts[2].x - data[GroupList[j]].RotatePts[2].x;
							double ddy = data[GroupList[j]].pts[2].y - data[GroupList[j]].RotatePts[2].y;
							for (int i = 0; i < 3; i++) {
								data[GroupList[j]].RotatePts[i].x += ddx;
								data[GroupList[j]].RotatePts[i].y += ddy;
							}
						...
						else if (EdgeIndex == 2)
						{
							...
							double dX, dY;
							double a, b, c = 1;
							dX = data[GroupList[j]].RotatePts[1].x - data[GroupList[j]].RotatePts[2].x;
							dY = data[GroupList[j]].RotatePts[1].y - data[GroupList[j]].RotatePts[2].y;
							...
							b = -a * data[GroupList[j]].RotatePts[2].x + c * data[GroupList[j]].RotatePts[2].y;
							double a01, a02;
							double b01, b02;
							double c01 = 1, c02 = 1;
							double dX01, dY01;
							...
							dX01 = data[GroupList[j]].RotatePts[0].x - data[GroupList[j]].RotatePts[1].x;
							dX02 = data[GroupList[j]].pts[0].x - data[GroupList[j]].pts[2].x;
							dY01 = data[GroupList[j]].RotatePts[0].y - data[GroupList[j]].RotatePts[1].y;
							dY02 = data[GroupList[j]].pts[0].y - data[GroupList[j]].pts[2].y;
							...
							b01 = -a01 * data[GroupList[j]].RotatePts[0].x + c01 * data[GroupList[j]].RotatePts[0].y;
							b02 = -a02 * data[GroupList[j]].RotatePts[0].x + c02 * data[GroupList[j]].RotatePts[0].y;

							if (a != 0) {
								if (c != 0) {
									data[GroupList[j]].RotatePts[1].x = (b01 - b) / (a - a01);
									data[GroupList[j]].RotatePts[1].y = (a * (b01 - b)) / (a - a01) + b;

									data[GroupList[j]].RotatePts[2].x = (b02 - b) / (a - a02);
									data[GroupList[j]].RotatePts[2].y = (a * (b02 - b)) / (a - a02) + b;
								}
								...
								data[GroupList[j]].RotatePts[1].x = -b01;
								data[GroupList[j]].RotatePts[1].y = a01 * data[GroupList[j]].RotatePts[1].x + b01;

								data[GroupList[j]].RotatePts[2].x = -b02;
								data[GroupList[j]].RotatePts[2].y = a02 - 2 * data[GroupList[j]].RotatePts[1].x + b02;
							}
			...
			else if (data[SelectIndex].shapeType == DrawMode::DTriangle)
			{
				if (true/*data[SelectIndex].theta == 0*/) {
					...
					else if (EdgeIndex == 1)
					{
						...
						/*if (data[SelectIndex].RotatePts[0] == data[SelectIndex].RotatePts[2] ||
						   data[SelectIndex].RotatePts[0] == data[SelectIndex].RotatePts[1]||
						   data[SelectIndex].RotatePts[2] == data[SelectIndex].RotatePts[1])
						   return;*/
						if (dX == 0)
						{
							a = 0;
					...
					else if (EdgeIndex == 2)
					{
						...
						double dX, dY;
						double a, b, c = 1;
						dX = data[SelectIndex].RotatePts[1].x - data[SelectIndex].RotatePts[2].x;
						dY = data[SelectIndex].RotatePts[1].y - data[SelectIndex].RotatePts[2].y;
						...
						b = -a * data[SelectIndex].RotatePts[2].x + c * data[SelectIndex].RotatePts[2].y;
						double a01, a02;
						double b01, b02;
						double c01 = 1, c02 = 1;
						double dX01, dY01;
						...
						dX01 = data[SelectIndex].RotatePts[0].x - data[SelectIndex].RotatePts[1].x;
						dX02 = data[SelectIndex].pts[0].x - data[SelectIndex].pts[2].x;
						dY01 = data[SelectIndex].RotatePts[0].y - data[SelectIndex].RotatePts[1].y;
						dY02 = data[SelectIndex].pts[0].y - data[SelectIndex].pts[2].y;
						...
						b01 = -a01 * data[SelectIndex].RotatePts[0].x + c01 * data[SelectIndex].RotatePts[0].y;
						b02 = -a02 * data[SelectIndex].RotatePts[0].x + c02 * data[SelectIndex].RotatePts[0].y;

						if (a != 0) {
							if (c != 0) {
								data[SelectIndex].RotatePts[1].x = (b01 - b) / (a - a01);
								data[SelectIndex].RotatePts[1].y = (a * (b01 - b)) / (a - a01) + b;

								data[SelectIndex].RotatePts[2].x = (b02 - b) / (a - a02);
								data[SelectIndex].RotatePts[2].y = (a * (b02 - b)) / (a - a02) + b;
							}
							...
							data[SelectIndex].RotatePts[1].x = -b01;
							data[SelectIndex].RotatePts[1].y = a01 * data[SelectIndex].RotatePts[1].x + b01;

							data[SelectIndex].RotatePts[2].x = -b02;
							data[SelectIndex].RotatePts[2].y = a02 - 2 * data[SelectIndex].RotatePts[1].x + b02;
						}
	...
	else if (selectID)
	{
		if (IsContainVector(SelectIndex, GroupList)) {
			...
			for (int j = 0; j < GroupList.size(); j++) {
				...
				{
					/*if (data[GroupList[j]].shapeType == DrawMode::DEllipse) {
						data[GroupList[j]].RotatePts[0].x = pts_0.x;
						data[GroupList[j]].RotatePts[0].y = pts_0.y;

						data[GroupList[j]].RotatePts[1].x = pts_2.x;
						data[GroupList[j]].RotatePts[1].y = pts_0.y;

						data[GroupList[j]].RotatePts[2].x = pts_2.x;
						data[GroupList[j]].RotatePts[2].y = pts_2.y;

						data[GroupList[j]].RotatePts[3].x = pts_0.x;
						data[GroupList[j]].RotatePts[3].y = pts_2.y;
					}*/
					if (data[GroupList[j]].pts[i] != data[GroupList[j]].RotatePts[i])
					{
						RollbackInfo info;
