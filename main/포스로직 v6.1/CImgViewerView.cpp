...
void CImgViewerView::OnContextmenuBallcount()
{
    ...
    if (GroupList.size() == 1) {
        ...
        {
            vector<Point2d> _pts;
            Point2d pt = (data[GroupList[0]].pts[data[GroupList[0]].tri_idx.x] + data[GroupList[0]].pts[data[GroupList[0]].tri_idx.y]) / 2;

            int arr[6] = { 0,1,2,3,0,1 };
            int Index1 = arr[data[GroupList[0]].tri_idx.x + 2];
            int Index2 = arr[data[GroupList[0]].tri_idx.y + 2];
            if (Index2 > Index1) {
                int d = Index2;
                Index2 = Index1;
                Index1 = d;
            ...
            _pts.push_back(pt);
            _pts.push_back(data[GroupList[0]].pts[Index1]);
            _pts.push_back(data[GroupList[0]].pts[Index2]);
            BallCount = this->m_Algorithm.BallCounting(_pts);
        }
        ...
        {
            vector<Point2d> _pts;
            Point2d pt = (data[SelectIndex].pts[data[SelectIndex].tri_idx.x] + data[SelectIndex].pts[data[SelectIndex].tri_idx.y]) / 2;

            int arr[6] = { 0,1,2,3,0,1 };
            int Index1 = arr[data[SelectIndex].tri_idx.x + 2];
            int Index2 = arr[data[SelectIndex].tri_idx.y + 2];
            if (Index2 > Index1) {
                int d = Index2;
                Index2 = Index1;
                Index1 = d;
            ...
            _pts.push_back(pt);
            _pts.push_back(data[SelectIndex].pts[Index1]);
            _pts.push_back(data[SelectIndex].pts[Index2]);
            BallCount = this->m_Algorithm.BallCounting(_pts);
        }
