...
// MFCparamDoc.cpp: CMFCparamDoc 클래스의 구현
//
...
// 축소판 그림을 지원합니다.
void CMFCparamDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMFCparamDoc::InitializeSearchContent()
{
...
void CMFCparamDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
