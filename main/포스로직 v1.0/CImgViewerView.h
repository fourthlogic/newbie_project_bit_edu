...
public:
	...
	void DrawCircle(CDC* pDC, vector<Vec3f>& circleCenter); // 원
	void DrawCirLines(CDC* pDC, vector<pair<Point2d, Point2d>>& cirLinePoints); // 선
	void DrawCirPoint(CDC* pDC, Point2d interPoint); // 교점
