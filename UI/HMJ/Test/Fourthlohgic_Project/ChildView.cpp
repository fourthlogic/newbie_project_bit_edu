...
CChildView::CChildView()
{
	...
	if (dlg.DoModal() == IDOK)
	{
		...
		src = imread(strStd);
		// target = 변환(src);
		// m_bCJGROUND = Convert2Bitmap(target);
		HBITMAP hBit = Convert2Bitmap(src);
...
HBITMAP CChildView::Convert2Bitmap(Mat& src)
{
